...
const ResignationPdf = ({route, navigation}) => {
  ...
  const valueJobLeaving = route?.params?.valueJobLeaving || null;
  const valueJobEntry = route?.params?.valueJobEntry || null;
        ...
        <div class="main">
          <div class="title">
            ...
            <div class="titlename">
              ...
              <div class="titlesubname">
                ...
                <div>İNSAN KAYNAKLARI MÜDÜRLÜĞÜ'NE</div>
          ...
          <div class="textarea">
            <div class="text">
             ${
               valueJobEntry || ' '
             } tarihinden beri çalışmakta olduğum işyerinizden ${
        valueJobLeaving || ' '
      } tarihinden 
             geçerli olarak kendi isteğimle ayrılmak istiyorum.
