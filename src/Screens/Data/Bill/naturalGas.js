  ...
  return (
    <Fragment>
      ...
      <ScrollView style={styles.main}>
        ...
        <View style={styles.area}>
          <View style={styles.textArea}>
            <Text style={styles.text}>Abone Numarası:</Text>
          </View>
          <View style={styles.inputArea}>
            <TextInput
              style={styles.input}
              ...
              placeholderTextColor="#3E5C76"
              placeholder="Doğalgaz Abone Numaranız..."
        ...
        <View style={styles.area}>
          <View style={styles.textArea}>
            <Text style={styles.text}>Aylık ortalama metreküp:</Text>
          </View>
          <View style={styles.inputArea}>
            <TextInput
              style={styles.input}
              ...
              placeholderTextColor="#3E5C76"
              placeholder="Gecen ay'ın metreküp ölçümü..."
              onChangeText={(text) => setcubicMeter(text)}
            />
          </View>
        </View>
        ...
        <View style={styles.area}>
          <View style={styles.textArea}>
            <Text style={styles.text}>Doğalgaz Şirketinin Adı:</Text>
          </View>
          <View style={styles.inputArea}>
            <TextInput
              style={styles.input}
        ...
        <View style={styles.areaButton}>
          <View style={styles.textArea}>
            <Text style={styles.text}>Fatura Tarihi:</Text>
          </View>
        ...
        <View style={styles.buttonArea}>
          <TouchableOpacity
            onPress={() =>
              navigation.navigate('naturalGasPdf', {
              valuetc:tcno,
              valuename:name,
              valueadress:adress,
