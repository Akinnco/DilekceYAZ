    ...
    await RNPrint.print({
      ...
      <body>
        <div class="main">
          ...
          <div class="textarea">
            <div class="text">
             ${valuecity} ilimizin ${valueserialnumber}  sayaç numaralı aşağıda belirtilen adreste bulunan ve
              ${valuetc} kimlik numaralı su abonesiyim. ${valuedatePicker} tarihinde adıma ve belirtilen sayaç numarasına düzenlenen 
             ${valuemoney} TL'lik faturanın tarafıma hatalı gönderildiğini düşünmekteyim. Aylık ortalama
              ${valueoldmoney} TL olarak gelen su faturası , bu ay su kullanımında herhangi bir artış olmamasına ragmen yüksek gelmiştir,
           bu nedenle ekte bilginize sunmuş olduğum faturaya itiraz ediyorum ve gerekli kontrollerin yapılmasını ve 
           faturamın tekrar düzenlenmesini talep ediyorum.
            </div>
          <div class="adressandtel_area">
           ...
           <div class="adressandtel">
             <div class="adress">ADRES:<br>${valueadress}
