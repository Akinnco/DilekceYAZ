  ...
  return (
    <Fragment>
      ...
      <ScrollView style={styles.main}>
        ...
        <View style={styles.area}>
          <View style={styles.textArea}>
            <Text style={styles.text}>Sayaç Numarası:</Text>
          </View>
          <View style={styles.inputArea}>
            <TextInput
              style={styles.input}
              ...
              placeholderTextColor="#3E5C76"
              placeholder="Su Faturası Sayaç Numaranız..."
        ...
        <View style={styles.area}>
          <View style={styles.textArea}>
            <Text style={styles.text}>Su Şirketinin Adı:</Text>
          </View>
          <View style={styles.inputArea}>
            <TextInput
              style={styles.input}
        ...
        <View style={styles.buttonArea}>
          <TouchableOpacity
            onPress={() =>
              navigation.navigate('waterBillPdf', {
              valuetc:tcno,
              valuename:name,
              valueadress:adress,
              valuecity:city,
